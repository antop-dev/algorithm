...
1. 현재 단어의 첫 글자가 바로 전 단어의 마지막 글자와 다르면 탈락
2. 현재 단어 이전의 모든 단어들 중 사용한 단어가 있으면 탈락
...
```
 ...
 4 번째 : effect → take
 5 번째 : take → either
 6 번째 : either → recognize
 7 번째 : recognize → encourage
 8 번째 : encourage → ensure
 9 번째 : ensure → establish
10 번째 : establish → hang
11 번째 : hang → gather
12 번째 : gather → refer
13 번째 : refer → reference
14 번째 : reference → estimate
15 번째 : estimate → executive
```
